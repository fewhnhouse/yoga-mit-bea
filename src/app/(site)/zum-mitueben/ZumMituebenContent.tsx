              ...
              <div className='bg-white/80 backdrop-blur rounded-2xl p-6 md:p-8 mb-10 text-left max-w-2xl mx-auto'>
                ...
                <ol className='space-y-4 text-charcoal-light'>
                  <li className='flex gap-4'>
                    <span className='w-8 h-8 rounded-full bg-sage text-white flex items-center justify-center flex-shrink-0 text-sm font-medium'>
                      1
                    </span>
                    <span>
                      Klicke auf den Button unten, um dem Online-Raum
                      beizutreten
                    </span>
                  </li>
                  <li className='flex gap-4'>
                    ...
                    <span>
                      Melde dich mit deinem Google-Konto an, oder trete als Gast
                      bei
                    </span>
                  </li>
                  <li className='flex gap-4'>
                    ...
                    <span>
                      Bereite deine Yogamatte vor und mach es dir gemütlich
                    </span>
                  </li>
                </ol>
              </div>
